...
private:
    ...
    void dispatch(const clang::Expr *Expr, const clang::FunctionDecl *Decl);
...
{
    Writer_.write("/*\n"
                  " * Generated by ccmock " CCMOCK_VERSION_CORE
                  " <" CCMOCK_WEBSITE ">\n"
                  " *\n");
    /* clang-format on */
    ...
    const auto &Base = Config_->General.BaseDirectory;
...
{
    const auto &Path = getConfig().General.Output.native();
