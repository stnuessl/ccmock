...
void CompilationDatabase::load(const std::filesystem::path &Path, std::string &Error)
{
...
void CompilationDatabase::detect(const std::filesystem::path &Path, std::string &Error)
{
